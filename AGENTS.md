...
- `warm-minimal` 팔레트 값: 코랄 `#D85A30` / 연코랄 배경 `#FAECE7`·텍스트 `#993C1D` / 확인 초록 `#1D9E75` / 파트너 골드 `#E8B84B` / 웜 배경 `#FBF8F5` / 중립 표면 `#faf7f5` / 테두리 `#f0e9e3`·`#ede4de` / 텍스트 `#2a2320`·보조 `#8a7a70`. (`PlaceDetailCard.tsx`에서 시작 → 소비자 UI 전역 톤으로 승격.)
